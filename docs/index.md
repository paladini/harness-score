...
hero:
  ...
  tagline: One deterministic command measures your Cursor harness — AGENTS.md, rules, hooks, tests, CI — and tells you exactly what to fix. No AI in the scan. No network. Same score every time.
  image:
    src: /logo.svg
    alt: Harness Score
  actions:
