...
|---|---|---|
| पुराना guide | एजेंट पुरानी convention अपनाता है | architecture छूने वाले PR में harness files की समीक्षा करें |
| अत्यधिक context | एजेंट file के बीच के निर्देश ignore करता है | rules scope करें; procedures skills में ले जाएँ |
| अस्पष्ट guidance | एजेंट रचनात्मक रूप से interpret करता है | rules को ठोस और जाँच योग्य बनाएँ |
| guide अनदेखा | वही गलती बार-बार | sensor या hook पर escalate करें (अध्याय 4–5) |
